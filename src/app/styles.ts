export const styles = {
  ...
  // File upload
  fileUpload: "flex items-center space-x-3 cursor-pointer transition-colors duration-200 px-6 py-4 rounded-lg",
  fileUploadText: "font-medium",
  uploadIcon: "w-5 h-5 text-white",
  fileInput: "hidden",
  
  // URL input
  urlInput: "bg-transparent outline-none text-white font-medium placeholder-white placeholder-opacity-40 px-6 py-4 rounded-lg",
  
  // Writing section
  writingSection: "mt-6 space-y-4",
  writingContainer: "w-full",
  textarea: "w-full h-[60vh] bg-gray-800 border border-[#85F4A6]/30 rounded-lg px-6 py-4 text-white font-medium placeholder-white/50 resize-none outline-none custom-scrollbar",
  
  // Button
  buttonContainer: "flex justify-center my-12",
  button: "bg-white text-gray-800 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 cursor-pointer",
} as const
